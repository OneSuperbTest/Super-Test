...
export async function executePrefixCommand(
  ...
  try {
    ...
    // Some commands (such as unzip) intentionally use custom prefix syntax
    // instead of mirroring their slash-command subcommands.
    if (!command.prefixBypassValidation) {
